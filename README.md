...
<p align="center">
  <strong>Accenture Innovation Challenge — Round 2 | Track 3: BusinessIntelligence.ai</strong><br>
  <strong>Team ZEUS</strong>
</p>

<p align="center">
  <em>Diagnose the movement. Rank the drivers. Measure confidence. Recommend the action.</em>
</p>
...
- [Real Data, Real Anomalies, No Hand-Waving](#real-data-real-anomalies-no-hand-waving)
- [The 5 Mandated Scenarios — All Working, All Real](#the-5-mandated-scenarios--all-working-all-real)
- [What's Deterministic vs. What's AI](#whats-deterministic-vs-whats-ai)
